...
Cone::Cone(float h, float r, glm::vec3 col)
{
    height = h;
    radius = r;
    ...
    //Botom
    vertices.push_back(Vertex(glm::vec3(radius, 0.0, 0.0), glm::vec3(1.0, 0.0, 0.0), col)); // 2 + 0*3 + 0 = 2
    vertices.push_back(Vertex(glm::vec3(radius, 0.0, 0.0), glm::vec3(0.0, -1.0, 0.0), col)); // 2 + 0*3 + 1 = 3
    //Top
    vertices.push_back(Vertex(centerTop, glm::vec3(1.0, 0.0, 0.0), col)); // 2 + 0*3 + 2 = 4
    //vertices.push_back(Vertex(glm::vec3(radius, height, 0.0), glm::vec3(0.0, 1.0, 0.0), col)); // 2 + 0*4 + 3 = 5
    ...
    for(int i = 1; i <= NumberOfSegment; ++i)
    {
        ...
        if (i < NumberOfSegment)
        {
            ...
            //Botom Vertices
            vertices.push_back(Vertex(glm::vec3(radius*cosf(angle), 0.0, radius*sinf(angle)), rotate*glm::vec3(cosf(angle), 0.0, sinf(angle)), col)); // 2 + 0*0 + 0
            vertices.push_back(Vertex(glm::vec3(radius*cosf(angle), 0.0, radius*sinf(angle)), glm::vec3(0.0, -1.0, 0.0), col)); // 2 + 0*0 + 1
            //Top Vertices
            vertices.push_back(Vertex(centerTop, rotate*glm::vec3(cosf(angle), 0.0, sinf(angle)), col)); // 2 + 0*0 + 2
            //vertices.push_back(Vertex(glm::vec3(radius*cosf(angle), height, radius*sinf(angle)), glm::vec3(0.0, 1.0, 0.0), col)); // 2 + 0*0 + 3
        }
